...
public class CrudProduct {
    ...
    public CrudProduct() {
        ...
        productList.add(new Product(1,"Thao Mai",5000000,"https://we25.vn/media2018/Img_News/2019/10/05/hotgirl-cuu-sinh-vien-dh-su-pham_20191005090410.jpg",crudCategory.categoryList.get(1),true));
    }
